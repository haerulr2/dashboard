  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "[&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 border-zinc-500 bg-zinc-800 text-zinc-300",
        "data-[placeholder]:text-zinc-300 [&_svg:not([class*='text-'])]:text-zinc-300",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-zinc-800 text-zinc-300 data-[state=open]:animate-in",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-zinc-600 focus:text-white [&_svg:not([class*='text-'])]:text-zinc-300",
        "relative flex w-full cursor-default items-center gap-2 rounded-sm",
        "py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none",
        "data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        "[&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex",
        "*:[span]:last:items-center *:[span]:last:gap-2 hover:[&_svg:not([class*='text-'])]:text-white",
